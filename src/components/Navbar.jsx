...
export default function Navbar({ handleThemeSelect, selectedTheme, handleText, text }) {
    ...
    const handleDisplayContent = () => {displayContent1 === true ? setDisplayContent1(false) : displayContent2 === true ? setDisplayContent2(false) : displayContent3 === true ? setDisplayContent3(false) : (<></>) }
    const handleDisplayBorder = () => {setBorder1(false);setBorder2(false);setBorder3(false);}
    const handleDisplayContent1 = () => {setDisplayContent1(!displayContent1); setDisplayContent2(false); setDisplayContent3(false); setBorder1(!border1); setBorder2(false); setBorder3(false);};   
    const handleDisplayContent2 = () => {setDisplayContent2(!displayContent2); setDisplayContent1(false); setDisplayContent3(false); setBorder2(!border2); setBorder1(false); setBorder3(false);};   
    const handleDisplayContent3 = () => {setDisplayContent3(!displayContent3); setDisplayContent1(false); setDisplayContent2(false); setBorder3(!border3); setBorder1(false); setBorder2(false);};  
            ...
            <div className="menu-wrapper">
                <div>
                    <div className="Nav-Btn">
                        ...
                        <button className="menu-btn hamb-btn " type="button" onClick={() => { setMenuStatus(!menuStatus); handleDisplayContent(); handleDisplayBorder();}}><img src="/images/hamb-menu.svg" alt="" /></button>       
                            
                    </div>
                    <div className="btns-div">
                        <button style={{display: menuDisplay, borderBottom: borderDisplay1}} className="menu-btn menu-btn1" type="button" onClick={handleDisplayContent1}>Comprar</button>       
                        <button style={{display: menuDisplay, borderBottom: borderDisplay2}} className="menu-btn menu-btn2" type="button" onClick={handleDisplayContent2}>Descobrir</button>       
                        <button style={{display: menuDisplay, borderBottom: borderDisplay3}} className="menu-btn menu-btn3" type="button" onClick={handleDisplayContent3}>Ajuda</button>   
                    </div>
                ...
                <div className="Nav-Right">
                    <div>
                        <input className="inputok" style={{display: inputDisplay}} type="text" value={text} placeholder="Procurar..." onChange={handleChange}/>
                        {text !== "" && <NavLink className="okbtn" style={{display: inputDisplay}} to={`/products/search/${text}`}>OK</NavLink>}
                        <button type="button" className="search-btn"><img src="/images/search.svg" alt="" onClick={() => {setInputStatus(!inputStatus);}} /></button>
                    </div>
                    <Cart />
                </div>
            </div> 
